<template>
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 d-lg-none">
    ...
    <div class="d-flex align-items-center gap-2">
      <span class="menu-sync d-flex align-items-center justify-content-center me-2" style="cursor:pointer;"><i
          class="fas fa-sync-alt fa-lg"></i></span>
      <span class="menu-ajuste d-flex align-items-center justify-content-center" style="cursor:pointer;"><i
